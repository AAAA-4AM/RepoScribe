...
const GenerationStep = ({ step, currentStep, title, description }: {
  step: number;
  currentStep: number;
  title: string;
  description: string;
...
const DocumentationPreview = ({ documentation }: { documentation: Documentation }) => {
      ...
      <div className="p-6 border-b border-white/10">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="text-xl font-semibold text-white">Documentation Generated</h3>
...
export default function DocumentationGenerator({ repository, onBack }: DocumentationGeneratorProps) {
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-8">
        ...
        >
          <div>
            ...
            <p className="text-xl text-gray-300">
              For repository: <span className="text-blue-300 font-semibold">{repository.full_name}</span>
            </p>
          </div>
          <motion.button
            onClick={onBack}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            {documentation && (
              ...
              >
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <h3 className="text-lg font-semibold text-green-400">Documentation Complete!</h3>
                </div>
                <p className="text-gray-300 mb-4">
                  Your documentation has been successfully generated and is ready for download.
                </p>
          ...
          <div className="space-y-6">
            ...
            >
              <h3 className="text-xl font-semibold text-white mb-4">Repository Details</h3>
            ...
            {documentation && <DocumentationPreview documentation={documentation} />}
          </div>
        </div>
      </div>
    </div>
